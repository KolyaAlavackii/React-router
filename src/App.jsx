            ...
            <div className="app">
                ...
                <Content>
                    ...
                    <Switch>
                        ...
                        <PrivateRoute exact path='/books/:topic?' component={Books} data={this.props.books} user={this.state.user} />
                        <PrivateRoute path='/books/:topic/:book' component={Books} data={this.props.books} user={this.state.user} />
